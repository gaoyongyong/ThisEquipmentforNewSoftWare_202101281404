...
namespace PropertyGridEx
{
    ...
    public class TypeListstring : TypeConverterGeneral<List<string>> 
    {
    }

    public class StringCollectionTypeDescriptor : CustomTypeDescriptor
    {
    ...
    public class BarEditor : UITypeEditor
    {
